/* Archivo con las opciones para la administración del sistema de estacionamiento*/ 
    ...
    do{
        ...
        switch(op) {
            ...
            case 7:
                ...
                cin.ignore();
                getline(cin, nombre);
                facturas = consultarTicket(PATH_CORTES_CAJA, nombre);
            ...
            case 8:
                ...
                cin.ignore();
                getline(cin, nombre);
                facturas = consultarTicket(PATH_FACTURAS_SEMANALES, nombre);
                cout << "\n\t Ingresos: $" << facturas.get_totalGanancias();
                cout << "\n\t Tickets contados: " << facturas.get_cantTickets();
                break;
            case 9:
                ...
                cin.ignore();
                getline(cin, nombre);
                facturas = consultarTicket(PATH_FACTURAS_MENSUALES, nombre);
                cout << "\n\t Ingresos: $" << facturas.get_totalGanancias();
                cout << "\n\t Tickets contados: " << facturas.get_cantTickets();
                break;
            case 10:
                ...
                //cin.ignore();
                getline(cin, nombre);
                facturas = consultarTicket(PATH_FACTURAS_GENERALES, nombre);
                cout << "\n\t Ingresos: $" << facturas.get_totalGanancias();
                cout << "\n\t Tickets contados: " << facturas.get_cantTickets();
                break;
