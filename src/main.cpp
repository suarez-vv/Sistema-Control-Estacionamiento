...
const string CADMIN = "0123";
const string CAPAGAR = "0000";
    ...
    do{
        ...
        if(!siEsta){
            ...
            if(strcmp(e.get_tipoVehiculo(), "Auto") == 0){
                if((contVehiculo = contAutos(false)) == -2) return;
                contVehiculo--;
                if((contVehiculo = contAutos(true, contVehiculo)) == -2) return;
            }else if(strcmp(e.get_tipoVehiculo(), "Moto") == 0){
                if((contVehiculo = contMotos(false)) == -2) return;
                contVehiculo--;
                if((contVehiculo = contMotos(true, contVehiculo)) == -2) return;
            }else{
                if((contVehiculo = contCamiones(false)) == -2) return;
                contVehiculo--;
                if((contVehiculo = contCamiones(true, contVehiculo)) == -2) return;
            }
